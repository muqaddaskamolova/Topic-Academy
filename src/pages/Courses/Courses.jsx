      ...
      <ul className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-5">
        ...
        <li className="bg-base-200 rounded-2xl pb-5 shadow-md flex flex-col">
          ...
          <div className="px-5 py-4 flex flex-col flex-grow">
            ...
            <p className="text-sm mb-5 flex-grow">
              <span className="text-yellow-600">{t("")} Koreys tilini</span> {t("")} chuqur
        ...
        <li className="bg-base-200 rounded-2xl pb-5 shadow-md flex flex-col">
          ...
          <div className="px-5 py-4 flex flex-col flex-grow">
            ...
            <p className="text-sm mb-5 flex-grow">
              O’qituvchidan <span className="text-yellow-600">{t("")} individual</span> {t("")} dars olmoqchi bo’lganlar uchun haftada 3 kun 1.5 soatdan darslar. Moslashuvchan grafik va individual yondashuv.
            </p>
            <span className="flex items-center justify-between">
              <button className="btn btn-accent rounded-full px-6 text-xs text-white">
                {t("")} Ro'yhatdan o'tish
